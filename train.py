...
parser.add_argument('--libsvm', action='store_true', help='if present, forces the use of libsvm;' +\
	' otherwise, liblinear is used')
...
library = LibsvmWrapper() if args.libsvm else LiblinearWrapper()
